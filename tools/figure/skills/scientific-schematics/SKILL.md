...
Read `../../INTEGRATIONS.zh-CN.md` before applying this skill in MathModel Workbench. Use project graphicsTools settings and the project environment; examples do not override user choices or require installing unrelated tools. Upstream provenance and copyright: `../UPSTREAM.json` and `../LICENSE.md`.
