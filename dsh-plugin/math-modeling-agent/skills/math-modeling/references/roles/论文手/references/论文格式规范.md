...
```powershell
python "<SKILL_ROOT>/tools/docx/scripts/equations.py" convert-latex "<PROJECT_ROOT>/完整论文-LaTeX/main.tex" --output "<PROJECT_ROOT>/完整论文.docx" --template "<PROJECT_ROOT>/当届官方模板.docx"
```
