...
完整源码构建与验证说明：[升级分支安装指南](https://github.com/Wuyanqiao/math-modeling-skill/blob/codex/universal-upgrade/dsh-plugin/README.md)。运行时 API 在包内 `skills/math-modeling/RUNTIME_API.md`。若分支尚未推送，以本地 checkout 的文档为准。
