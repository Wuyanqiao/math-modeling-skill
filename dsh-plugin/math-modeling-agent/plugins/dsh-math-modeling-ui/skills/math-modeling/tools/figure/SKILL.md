...
description: >-
  ...
  导出和文件审计。数学建模场景额外支持三类图体系（原始数据/过程/结果）、子问题覆盖检查和建模流程图规范。
...
并扩展数学建模特有的三类图体系、子问题覆盖检查和建模流程图。**永远先思考再画**：
...
**数据图范围**：折线、柱状、散点、箱线/小提琴、热力图、误差棒、分布图、相关性矩阵、雷达图、
...
| `chart-types/flowchart.md` | 需要画总体/子问题建模流程图时读——样式、生成路线、导出与自检 |
