...
本文件保留 2.0.0 的验收证据；当前 2.1.0 能力和验证见 [2.1 升级记录](upgrade-2.1-verification.md)。

基于上游 `3c4bd1927663327812665941a445281b9c008a78`，在 `WuYanqiao/universal-upgrade` 实施。原 fork 落后的 16 个提交已先完成快进同步。本文件记录本地开发版的实际验证；CI 配置、模拟测试、真实宿主挂载和桌面端到端测试分别计量。
